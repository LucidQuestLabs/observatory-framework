...
- Initialized baseline corpus from the Observatory Framework export packet.
...
- Added Texas Range faux-data MVP prototype with synthetic target packet, approved observations, dossier, public briefing, and site links.
- Added founding decisions anchor and coherence updates for planning, deployment, and backlog docs.
